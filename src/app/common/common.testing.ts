...
const FAKE_SVGS = {
  ...
  green_leaf: '<svg><path id="green-leaf" name="green-leaf"></path></svg>',
}
...
export class MatIconRegistryFake {
  ...
  getNamedSvgIcon(name: string, namespace: string = ''): Observable<SVGElement> {
    return of(this._svgElementFromString(FAKE_SVGS.green_leaf))
  }

  /**
   * Returns the CSS class name to be used for icon fonts
   * when an `<mat-icon>` component does not have a fontSet input value,
